#!/usr/bin/env python3
"""Strict numerical comparison for separate-process spectral probes."""
...
def compare(a, b, path="root"):
    ...
    if isinstance(a, (int, float)) and isinstance(b, (int, float)):
        ...
        # atol is intentionally zero. This is the frozen Phase-4 parity gate.
...
print(f"max_abs={max_abs:.3e} max_rel={max_rel:.3e} rtol={args.rtol:.1e} atol=0")
if failures:
    print("FAIL")
